...
import com.example.android.autoeditor.Classifier.Recognition;
  ...
  public synchronized void drawDebug(final Canvas canvas) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      if (getFrameToCanvasMatrix().mapRect(trackedPos)) {
        @SuppressLint("DefaultLocale") final String labelString = String.format("%.2f", trackedObject.getCurrentCorrelation());
