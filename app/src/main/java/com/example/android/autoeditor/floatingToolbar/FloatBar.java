...
public class FloatBar extends LinearLayoutCompat implements View.OnClickListener,
    ...
    public FloatBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.FloatBar, 0, 0);
        ...
        mShowToast = a.getBoolean(R.styleable.FloatBar_floatingToastOnLongClick, true);
        mHandleFabClick = a.getBoolean(R.styleable.FloatBar_floatingHandleFabClick, true);
        mItemBackground = a.getResourceId(R.styleable.FloatBar_floatingItemBackground,
                outValue.resourceId);
        mAutoHide = a.getBoolean(R.styleable.FloatBar_floatingAutoHide, true);
        mMenuRes = a.getResourceId(R.styleable.FloatBar_floatingMenu, 0);

        int customView = a.getResourceId(R.styleable.FloatBar_floatingCustomView, 0);
